...
const ProfilePage: React.FC = () => {
    ...
    const EditField: React.FC<{ label: string; name: string; value: string | number | undefined; onChange: any, type?: string, children?: React.ReactNode }> = ({ label, name, value, onChange, type = 'text', children }) => (
         <div>
    ...
    return (
        <div className="max-w-4xl mx-auto">
            ...
            {/* Profile Header */}
            <div className="bg-slate-800/80 rounded-t-lg border border-b-0 border-slate-700 p-6 md:p-8">
            ...
            {isEditing ? (
                // Edit Form
                <div className="bg-slate-800 rounded-b-lg border border-t-0 border-slate-700 p-6 md:p-8 space-y-4 animate-fade-in-down">
                    ...
                    <EditField label="Avatar URL" name="avatarUrl" value={profileData.avatarUrl} onChange={handleInputChange} />
                     <div className="pt-4">
                ...
                // Activity Feed
                <div className="bg-slate-800/50 rounded-b-lg border border-t-0 border-slate-700 p-6 md:p-8">
